...
(1, 'Alexandre', 'Araújo', '91984188928', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'alexandre@gmail.com', 'e10adc3949ba59abbe56e057f20f883e'),
(2, 'João Paulo', 'Costa', '91754395984', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'joao.paulo@gmail.com', 'a966390ad00cd1f1ff0c71917b514116'),
(3, 'ivo', 'miranda', '91982428090', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ivoomiranda@gmail.com', 'e10adc3949ba59abbe56e057f20f883e'),
...
(1, 'Ivo', 'Miranda', '91984188928', 'ivo@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', NULL),
...
--
ALTER TABLE `tb_categoria`
  MODIFY `cdcategoria` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tb_cliente`
--
ALTER TABLE `tb_cliente`
  MODIFY `cdcliente` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_funcionario`
  MODIFY `cdfuncionario` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_produto`
  MODIFY `cdproduto` int(11) NOT NULL AUTO_INCREMENT;
