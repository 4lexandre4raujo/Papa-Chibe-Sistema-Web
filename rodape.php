...
<footer class="text-justify text-white" style="background-color: #9C0000;">
  <!-- Grid container -->
  <div class="container p-4">
    ...
    <section class="mb-4">
        ...
        <p>
            PAPA-CHIBÉ, Entre Pedro Miranda e marques - Tv. Vileta, 1206 - Pedreira, Belém - PA, 66087-422
        </p>
        <p>
            S.A.C: Dúvidas, reclamações, sugestões e / ou elogios envie um e-mail para: relacionamento@papachibe.com.br
        </p>
        <p>
            Informações sobre o uso de dados pessoais e pedidos de descadastro do banco de dados, clique aqui - Encarregado de Dados.
        </p>
    </section>
    <!-- Section: Text -->
